...
public class DesktopLauncher extends JFrame
{
	...
	private void createRegisterGUI()
	{
		...
		passwordConfirm.setBounds(95 + insets.left + passSign.getPreferredSize().width, 230 + insets.top, 100,
				size.height);
		...
		register.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e)
			{
				...
				{
					JOptionPane.showMessageDialog(null, "Passwords require 1 alpha character and 1 number",
							"Register Failed!", JOptionPane.WARNING_MESSAGE);
				}

				else if (passSignUp.getPassword() != passwordConfirm.getPassword())
				{
					JOptionPane.showMessageDialog(null, "Passwords don't match!", "Register Failed!",
	...
	void sound_woosh()
	{ // I hate copy-pasting codeeeeee (but libgdx sound isn't working in desktop launcher)
		Mixer.Info[] mixInfos = AudioSystem.getMixerInfo();
		mixer = AudioSystem.getMixer(mixInfos[0]);
